    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.muted}>Today · {workspace.timezone}</Text>
        </View>
      ...
      <View style={styles.panel}>
        <Text style={styles.panelTitle}>Your first service</Text>
        {service ? (
          <View style={styles.serviceRow}>
            <View>
              <Text style={styles.appointmentName}>{service.name}</Text>
              <Text style={styles.helper}>{service.duration_minutes} min</Text>
            </View>
            <Text style={styles.price}>
              {Number(service.price_amount).toLocaleString("cs-CZ")} Kč
            </Text>
          </View>
        ) : (
          <Text style={styles.helper}>No active services yet.</Text>
        )}
      </View>
      <View style={styles.panel}>
...
const styles = StyleSheet.create({
  ...
  signOut: { padding: 8 },
  signOutText: { color: "#217464", fontWeight: "700" },
  ...
  price: { color: "#217464", fontWeight: "700" },
